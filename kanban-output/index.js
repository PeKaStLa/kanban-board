...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-3614d576.js",
      css: ["/./_app/assets/start-8077b9bf.css"],
      js: ["/./_app/start-3614d576.js", "/./_app/chunks/vendor-dddb85f2.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-8d8dcb4e.js", "css": ["/./_app/assets/pages/__layout.svelte-545622ef.css"], "js": ["/./_app/pages/__layout.svelte-8d8dcb4e.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null }, "src/routes/__error.svelte": { "entry": "/./_app/pages/__error.svelte-b9beb34e.js", "css": [], "js": ["/./_app/pages/__error.svelte-b9beb34e.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-0b5368fc.js", "css": ["/./_app/assets/pages/__layout.svelte-545622ef.css"], "js": ["/./_app/pages/index.svelte-0b5368fc.js", "/./_app/chunks/vendor-dddb85f2.js", "/./_app/pages/item.svelte-f6d3d649.js"], "styles": null }, "src/routes/column.svelte": { "entry": "/./_app/pages/column.svelte-e6786dd4.js", "css": [], "js": ["/./_app/pages/column.svelte-e6786dd4.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null }, "src/routes/item.svelte": { "entry": "/./_app/pages/item.svelte-f6d3d649.js", "css": [], "js": ["/./_app/pages/item.svelte-f6d3d649.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null } };
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  beforeUpdate(() => {
    autoscroll = divTodo;
    autoscroll = divProgress;
    autoscroll = divDone;
  });
  afterUpdate(() => {
    if (autoscroll)
      divTodo.scrollTo(0, divTodo.scrollHeight);
    if (autoscroll)
      divProgress.scrollTo(0, divProgress.scrollHeight);
    if (autoscroll)
      divDone.scrollTo(0, divDone.scrollHeight);
  });
  $$result.css.add(css);
...
<div class="${""}">
	<div class="${"  px-2  h-5/6   fixed  z-50 \n	 rounded-md content-start w-full \n		 grid-cols-3  grid"}"><div class="${"col-span-1 border-t-2 bg-gray-300 border-l-2 border-r-2 \n		rounded-t-md border-gray-500 p-1 mr-2"}"><h2 class="${"text-center text-2xl"}">ToDo:</h2></div>
		...
		<div class="${"p-2 col-span-1 mr-2 bg-gray-300 \n border-l-2 border-r-2 border-gray-500 " + escape2(is_empty(todo) ? "rounded-b-md  border-b-2" : "")}"><div class="${"text-center  overflow-hidden rounded-md \nborder-2  bg-gray-500 col-span-1 border-t-2 border-l-2 border-r-2 \nrounded-t-md border-gray-500 p-1 "}"><div class="${"inline-block   rounded-sm p-2"}"><input placeholder="${"enter an item"}"${add_attribute("value", textfieldTodo, 1)}></div>
				<div class="${"inline-block"}"><button class="${"bg-gray-100 p-2"}">Add Item</button></div></div></div>
		<div class="${"p-2 col-span-1 mr-2 bg-gray-300 \n border-l-2 border-r-2 border-gray-500 " + escape2(is_empty(progress) ? "rounded-b-md  border-b-2" : "")}"><div class="${"text-center  overflow-hidden rounded-md \nborder-2  bg-gray-500 col-span-1 border-t-2 border-l-2 border-r-2 \nrounded-t-md border-gray-500 p-1 "}"><div class="${"inline-block   rounded-sm p-2"}"><input placeholder="${"enter an item"}"${add_attribute("value", textfieldProgress, 1)}></div>
				<div class="${"inline-block"}"><button class="${"bg-gray-100 p-2"}">Add Item</button></div></div></div>

		<div class="${"p-2 col-span-1  bg-gray-300 \n border-l-2 border-r-2 border-gray-500 " + escape2(is_empty(done) ? "rounded-b-md  border-b-2" : "")}"><div class="${"text-center  overflow-hidden rounded-md \nborder-2  bg-gray-500  border-t-2 border-l-2 border-r-2 \nrounded-t-md border-gray-500 p-1 "}"><div class="${"inline-block   rounded-sm p-2"}"><input placeholder="${"enter an item"}"${add_attribute("value", textfieldDone, 1)}></div>
				<div class="${"inline-block"}"><button class="${"bg-gray-100 p-2"}">Add Item</button></div></div></div>

		<div class="${"max-h-full 	overflow-y-auto rounded-b-md "}"><div class="${"  px-1 " + escape2(is_empty(todo) ? "" : "border-b-2") + "   border-r-2 border-l-2 rounded-b-md  \n				bg-gray-300  \n			  border-gray-500 mr-2  max-h-full    	overflow-y-auto"}"${add_attribute("this", divTodo, 1)}><div class="${"  rounded-md \n		   col-span-1  "}">${!is_empty(todo) ? `${each(todo, (item2) => `${validate_component(Item, "Item").$$render($$result, { item: item2 }, {}, {})}`)}` : ``}</div></div></div>
		<div class="${"max-h-full 	overflow-y-auto "}"><div class="${"  px-1  " + escape2(is_empty(progress) ? "" : "border-b-2") + "  border-r-2 border-l-2 rounded-b-md  bg-gray-300  \n				border-gray-500 mr-2  max-h-full    	overflow-y-auto"}"${add_attribute("this", divProgress, 1)}><div class="${" rounded-md   		col-span-1  "}">${!is_empty(progress) ? `${each(progress, (item2) => `${validate_component(Item, "Item").$$render($$result, { item: item2 }, {}, {})}`)}` : ``}</div></div></div>
		<div class="${"max-h-full 	overflow-y-auto  "}"><div class="${" " + escape2(is_empty(done) ? "" : "border-b-2") + "  px-1   border-r-2 border-l-2 rounded-b-md bg-gray-300  \n				border-gray-500   max-h-full     	overflow-y-auto"}"${add_attribute("this", divDone, 1)}><div class="${" rounded-md col-span-1  "}">${!is_empty(done) ? `${each(done, (item2) => `${validate_component(Item, "Item").$$render($$result, { item: item2 }, {}, {})}`)}` : ``}</div></div></div></div>
</div>`;
});
