...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-bd0b4e0e.js",
      css: ["/./_app/assets/start-8077b9bf.css"],
      js: ["/./_app/start-bd0b4e0e.js", "/./_app/chunks/vendor-dddb85f2.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "/./_app/pages/__layout.svelte-8d8dcb4e.js", "css": ["/./_app/assets/pages/__layout.svelte-545622ef.css"], "js": ["/./_app/pages/__layout.svelte-8d8dcb4e.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null }, "src/routes/__error.svelte": { "entry": "/./_app/pages/__error.svelte-b9beb34e.js", "css": [], "js": ["/./_app/pages/__error.svelte-b9beb34e.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-2874fbe3.js", "css": ["/./_app/assets/pages/__layout.svelte-545622ef.css"], "js": ["/./_app/pages/index.svelte-2874fbe3.js", "/./_app/chunks/vendor-dddb85f2.js", "/./_app/pages/item.svelte-2c04354d.js"], "styles": null }, "src/routes/column.svelte": { "entry": "/./_app/pages/column.svelte-e6786dd4.js", "css": [], "js": ["/./_app/pages/column.svelte-e6786dd4.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null }, "src/routes/item.svelte": { "entry": "/./_app/pages/item.svelte-2c04354d.js", "css": [], "js": ["/./_app/pages/item.svelte-2c04354d.js", "/./_app/chunks/vendor-dddb85f2.js"], "styles": null } };
...
<div class="${" pb-16 "}"><nav class="${"bg-gray-800 fixed w-full justify-center text-center z-50  "}"><h1 class="${"text-3xl font-normal w-auto text-white p-2"}">Kanban-Board</h1></nav></div>
...
var Item = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<p class="${"overflow-ellipsis text-center overflow-hidden  \r\n border-2 rounded-md  my-2 p-2 bg-gray-100"}">${escape2(_ITEM)}</p>`;
});
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  beforeUpdate(() => {
    _AUTOSCROLL = _DIV_TODO;
    _AUTOSCROLL = _DIV_PROGRESS;
    _AUTOSCROLL = _DIV_DONE;
  });
  afterUpdate(() => {
    if (_AUTOSCROLL)
      _DIV_TODO.scrollTo(0, _DIV_TODO.scrollHeight);
    if (_AUTOSCROLL)
      _DIV_PROGRESS.scrollTo(0, _DIV_PROGRESS.scrollHeight);
    if (_AUTOSCROLL)
      _DIV_DONE.scrollTo(0, _DIV_DONE.scrollHeight);
  });
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Kanban-Board</title>`, ""}`, ""}

<div class="${""}">
	<div class="${"  px-2  h-5/6   fixed  z-50 \n	 rounded-md content-start w-full \n		 grid-cols-3  grid"}"><div class="${"col-span-1 border-t-2 bg-gray-300 border-l-2 border-r-2 \n		rounded-t-md border-gray-500 p-1 mr-2"}"><h2 class="${"text-center text-2xl"}">ToDo:</h2></div>
		<div class="${"col-span-1 border-t-2 bg-gray-300 border-l-2 border-r-2\n			 rounded-t-md border-gray-500 p-1 mr-2"}"><h2 class="${" text-center text-2xl"}">In Progress:</h2></div>
		<div class="${"col-span-1 border-t-2 bg-gray-300  border-l-2 border-r-2 \n			rounded-t-md border-gray-500 p-1 "}"><h2 class="${"text-center  text-2xl"}">Done:</h2></div>

		<div class="${"p-2 col-span-1 mr-2 bg-gray-300 \n border-l-2 border-r-2 border-gray-500 " + escape2(is_empty(_TODO) ? "rounded-b-md  border-b-2" : "")}"><div class="${"text-center  overflow-hidden rounded-md \nborder-2  bg-gray-500 col-span-1 border-t-2 border-l-2 border-r-2 \nrounded-t-md border-gray-500 p-1 "}"><div class="${"inline-block   rounded-sm p-2"}"><input placeholder="${"enter an _ITEM"}"${add_attribute("value", _TEXTFIELD_TODO, 1)}></div>
				<div class="${"inline-block"}"><button class="${"bg-gray-100 p-2"}">Add Item</button></div></div></div>
		<div class="${"p-2 col-span-1 mr-2 bg-gray-300 \n border-l-2 border-r-2 border-gray-500 " + escape2(is_empty(_PROGRESS) ? "rounded-b-md  border-b-2" : "")}"><div class="${"text-center  overflow-hidden rounded-md \nborder-2  bg-gray-500 col-span-1 border-t-2 border-l-2 border-r-2 \nrounded-t-md border-gray-500 p-1 "}"><div class="${"inline-block   rounded-sm p-2"}"><input placeholder="${"enter an _ITEM"}"${add_attribute("value", _TEXTFIELD_PROGRESS, 1)}></div>
				<div class="${"inline-block"}"><button class="${"bg-gray-100 p-2"}">Add Item</button></div></div></div>

		<div class="${"p-2 col-span-1  bg-gray-300 \n border-l-2 border-r-2 border-gray-500 " + escape2(is_empty(_DONE) ? "rounded-b-md  border-b-2" : "")}"><div class="${"text-center  overflow-hidden rounded-md \nborder-2  bg-gray-500  border-t-2 border-l-2 border-r-2 \nrounded-t-md border-gray-500 p-1 "}"><div class="${"inline-block   rounded-sm p-2"}"><input placeholder="${"enter an _ITEM"}"${add_attribute("value", _TEXTFIELD_DONE, 1)}></div>
				<div class="${"inline-block"}"><button class="${"bg-gray-100 p-2"}">Add Item</button></div></div></div>

		<div class="${"max-h-full 	overflow-y-auto rounded-b-md "}"><div class="${"  px-1 " + escape2(is_empty(_TODO) ? "" : "border-b-2") + "   border-r-2 border-l-2 rounded-b-md  \n				bg-gray-300  \n			  border-gray-500 mr-2  max-h-full    	overflow-y-auto"}"${add_attribute("this", _DIV_TODO, 1)}><div class="${"  rounded-md 		   col-span-1  "}">${!is_empty(_TODO) ? `${each(_TODO, (_ITEM) => `${validate_component(Item, "Item").$$render($$result, { _ITEM }, {}, {})}`)}` : ``}</div></div></div>
		<div class="${"max-h-full 	overflow-y-auto "}"><div class="${"  px-1  " + escape2(is_empty(_PROGRESS) ? "" : "border-b-2") + "  border-r-2 border-l-2 rounded-b-md  bg-gray-300  \n				border-gray-500 mr-2  max-h-full    	overflow-y-auto"}"${add_attribute("this", _DIV_PROGRESS, 1)}><div class="${" rounded-md   		col-span-1  "}">${!is_empty(_PROGRESS) ? `${each(_PROGRESS, (_ITEM) => `${validate_component(Item, "Item").$$render($$result, { _ITEM }, {}, {})}`)}` : ``}</div></div></div>
		<div class="${"max-h-full 	overflow-y-auto  "}"><div class="${" " + escape2(is_empty(_DONE) ? "" : "border-b-2") + "  px-1   border-r-2 border-l-2 rounded-b-md bg-gray-300  \n				border-gray-500   max-h-full     	overflow-y-auto"}"${add_attribute("this", _DIV_DONE, 1)}><div class="${" rounded-md col-span-1  "}">${!is_empty(_DONE) ? `${each(_DONE, (_ITEM) => `${validate_component(Item, "Item").$$render($$result, { _ITEM }, {}, {})}`)}` : ``}</div></div></div></div>
</div>`;
});
